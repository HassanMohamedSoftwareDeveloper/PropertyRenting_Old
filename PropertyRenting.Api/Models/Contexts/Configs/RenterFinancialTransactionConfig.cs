...
public class RenterFinancialTransactionConfig : IEntityTypeConfiguration<RenterFinancialTransactionEntity>
{
    public void Configure(EntityTypeBuilder<RenterFinancialTransactionEntity> builder)
    {
