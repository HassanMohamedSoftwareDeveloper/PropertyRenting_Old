...
namespace PropertyRenting.Api.Migrations
{
    ...
    [Migration("20221212091752_Add_InstallmentId_to_Voucher")]
    partial class Add_InstallmentId_to_Voucher
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.AccountSetupEntity", b =>
                {
                    ...
                    b.Property<Guid>("AccruedExpenseAccountId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("AccruedRevenueAccountId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ContributerAccountId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("RenterAccountId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AccruedRevenueAccountId");

                    b.HasIndex("ContributerAccountId");

                    b.HasIndex("ExpenseAccountId");

                    b.HasIndex("OwnerAccountId");

                    b.HasIndex("RenterAccountId");
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.CashBankEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.ContractAdditionsEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.ExchangeVoucherEntity", b =>
                {
                    ...
                    b.Property<string>("SanadNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("SanadTypeId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.RenterFinancialTransactionEntity", b =>
                {
                    ...
                    b.Property<Guid?>("ContractAdditionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.VoucherEntity", b =>
                {
                    ...
                    b.Property<long?>("ReferenceAutoNumber")
                        .HasColumnType("bigint");

                    b.Property<Guid?>("ReferenceId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ReferenceManualNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.AccountSetupEntity", b =>
                {
                    b.HasOne("PropertyRenting.Api.Models.Entities.AccountEntity", "AccruedExpenseAccount")
                        .WithMany("AccruedExpenseAccounts")
                        .HasForeignKey("AccruedExpenseAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PropertyRenting.Api.Models.Entities.AccountEntity", "AccruedRevenueAccount")
                        .WithMany("AccruedRevenueAccounts")
                        .HasForeignKey("AccruedRevenueAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PropertyRenting.Api.Models.Entities.AccountEntity", "ContributerAccount")
                        .WithMany("ContributerAccounts")
                        .HasForeignKey("ContributerAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("PropertyRenting.Api.Models.Entities.AccountEntity", "OwnerAccount")
                        .WithMany("OwnerAccounts")
                        .HasForeignKey("OwnerAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PropertyRenting.Api.Models.Entities.AccountEntity", "RenterAccount")
                        .WithMany("RenterAccounts")
                        .HasForeignKey("RenterAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("AccruedRevenueAccount");

                    b.Navigation("ContributerAccount");

                    b.Navigation("ExpenseAccount");

                    b.Navigation("OwnerAccount");

                    b.Navigation("RenterAccount");
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.ExchangeVoucherDetailsEntity", b =>
                {
                    b.HasOne("PropertyRenting.Api.Models.Entities.ContractAdditionsEntity", "Addition")
                        .WithMany()
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.ExchangeVoucherEntity", b =>
                {
                    b.HasOne("PropertyRenting.Api.Models.Entities.CashBankEntity", "CashBank")
                        .WithMany()
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.RenterFinancialTransactionEntity", b =>
                {
                    b.HasOne("PropertyRenting.Api.Models.Entities.ContractAdditionsEntity", "ContractAddition")
                        .WithMany()
            ...
            modelBuilder.Entity("PropertyRenting.Api.Models.Entities.AccountEntity", b =>
                {
                    ...
                    b.Navigation("AccruedExpenseAccounts");

                    b.Navigation("AccruedRevenueAccounts");

                    b.Navigation("ContributerAccounts");
